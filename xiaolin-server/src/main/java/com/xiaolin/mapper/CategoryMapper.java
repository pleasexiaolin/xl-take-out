...
public interface CategoryMapper extends BaseMapper<CategoryDO> {
    ...
    void changeStatus(@Param("status") Integer status, @Param("id") Long id, @Param("updateUser") String updateUser);
    ...
    void updateById(@Param("entity") CategoryDTO entity, @Param("updateUser") String updateUser);
}
